...
export const highlights: CSSProperties = { display: "flex", justifyContent: "center", gap: 32, marginTop: 44, flexWrap: "wrap" };
export const highlightItem: CSSProperties = { textAlign: "center", opacity: 0.9 };
export const highlightIcon: CSSProperties = { fontSize: 24 };
export const highlightText: CSSProperties = { fontSize: 13, marginTop: 4 };
